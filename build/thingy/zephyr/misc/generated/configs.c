...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TRACKER_PERIODIC_TIMEOUT, 600);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_MESSAGE_BUFFER_SIZE, 516);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 20480);
